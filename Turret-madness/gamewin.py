...
gamewin =p.image.load("images\\gamewin.png")
gamewin2= p.image.load("images\\gamewin2.png")
...
def main_menu():
    ...
    while running:
        if boton_1 == None and boton_2 == None:
            ...
            pantalla.blit(gamewin,(700,230))
            pantalla.blit(gamewin2, (-40, 230))
            ...
            draw_txt("GAME", font_2, (0, 0, 0), pantalla, 350, 180)
            draw_txt("GAME", font_2, (255, 255, 255), pantalla, 343, 175)
            draw_txt("WIN", font_1, (0, 0, 0), pantalla, 700, 180)
            draw_txt("WIN", font_1, (255, 255, 255), pantalla, 693, 175)
        else:
        ...
        draw_txt("Menu", font, (0, 0, 0), pantalla, 570, 370)
        draw_txt("Menu", font, (255, 255, 255), pantalla, 568, 368)
        ...
        if boton_1.collidepoint((mx, my)):
            ...
            draw_txt("menu", font, (0, 0, 0), pantalla, 568, 368)
            draw_txt("menu", font, (255, 255, 255), pantalla, 566, 366)
            canal1.play(tap)
            if click:
                canal2.play(select)
                import menu
